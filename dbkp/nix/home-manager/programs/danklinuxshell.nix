...

{
  ...
  settings = {
    ...
    customThemeFile = ../dotfiles/dms/themes/catppuccin/theme.json;
  ...
  plugins = {
    DankHyprlandWindows = { src = "${inputs.dms-plugins}/DankHyprlandWindows"; };
    DankGifSearch = { src = "${inputs.dms-plugins}/DankGifSearch"; };
    DankPomodoroTimer = { src = "${inputs.dms-plugins}/DankPomodoroTimer"; };
    EmojiLauncher = { src = "${inputs.dms-emoji-launcher}"; };
    WorldClock = { src = "${inputs.dms-world-clock}"; };
    GrimBlast = { src = "${inputs.dms-grimblast}/grimblast"; };
  };
}
